...
class MyFrame ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.m_menuItem13 = wx.MenuItem( self.m_rightclick_menu_single, wx.ID_ANY, u"Preform Query", wx.EmptyString, wx.ITEM_NORMAL )
		...
		self.m_menuItem53 = wx.MenuItem( self.m_rightclick_menu_single, wx.ID_ANY, u"Properties", wx.EmptyString, wx.ITEM_NORMAL )
		...
		self.m_listctrl_multi = wx.ListCtrl( self.m_panel_multi_search, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.LC_REPORT|wx.SUNKEN_BORDER )
		self.m_rightclick_menu_multi = wx.Menu()
		self.m_menuItem1 = wx.MenuItem( self.m_rightclick_menu_multi, wx.ID_ANY, u"Preform Query", wx.EmptyString, wx.ITEM_NORMAL )
